...
HD_PWD='C:/Users/Jochem/GitHub/Fontys/pong-digitaal/fontys-pong/fontys-pong.runs/blockdesign_controller_ultrasoni_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blockdesign_controller_ultrasoni_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blockdesign_controller_ultrasoni_0_1.tcl
