...
module Constants_imp_YX2WQJ
  ...
  PONG_ball_size_0 ball_size_RnM
       (.dout(Net9));
  PONG_max_score_0 max_score_RnM
       (.dout(xlconstant_6_dout));
  PONG_paddle_offset_x_0 paddle_offset_x_RnM
       (.dout(xlconstant_5_dout));
  PONG_paddle_size_x_0 paddle_size_x_RnM
       (.dout(Net7));
  PONG_paddle_size_y_0 paddle_size_y_RnM
       (.dout(Net8));
  PONG_score_seg_size_x_0 score_seg_size_x_RnM
       (.dout(score_seg_size_x_dout));
  PONG_score_seg_size_y_0 score_seg_size_y_RnM
       (.dout(score_seg_size_y_dout));
  PONG_scoreboard_center_offset_0 scoreboard_center_offset_RnM
       (.dout(scoreboard_center_offset_dout));
  PONG_scoreboard_top_offset_0 scoreboard_top_offset_RnM
       (.dout(scoreboard_top_offset_dout));
  PONG_screen_size_x_0 screen_size_x_RnM
       (.dout(Net5));
  PONG_screen_size_y_0 screen_size_y_RnM
       (.dout(Net6));
endmodule
...
module PONG
  ...
  Constants_imp_YX2WQJ Constants
       (.ball_size(Net9),
        ...
        .screen_size_x(Net5),
        .screen_size_y(Net6));
  PONG_clk_divider_0_0 clk_divider_0
       (.clk_i(Net),
        .clk_o(Net4),
        .reset(Net3));
  PONG_clk_wiz_0_0 clk_wiz_0
       (.clk_hdmi(clk_wiz_0_clk_hdmi),
        .clk_in1(Net),
        .reset(Net3));
  PONG_collision_detection_0_0 collision_detection_0
       (.ball_pos_x(position_ball_0_ball_pos_x),
        ...
        .screen_size_x(Net5),
        .screen_size_y(Net6));
  PONG_color_generator_0_0 color_generator_0
       (.data_o(color_generator_0_data_o),
        .enable_i(paint_scoreboard_pxl_value_o));
  controllers_imp_10DA66H controllers
  ...
  PONG_paint_centerline_0_0 paint_centerline_0
       (.clk(clk_wiz_0_clk_hdmi),
        ...
        .vsync_o(vsync_i_1));
  PONG_paint_paddle_l_0 paint_paddle_l
       (.clk(clk_wiz_0_clk_hdmi),
        .enable(enable_0_1),
  ...
  PONG_paint_paddle_r_0 paint_paddle_r
       (.clk(clk_wiz_0_clk_hdmi),
        .enable(enable_0_1),
  ...
  paint_scoreboard_imp_1D47EDC paint_scoreboard
       (.clk(Net),
  ...
  PONG_pixel_counter_0_0 pixel_counter_0
  ...
  PONG_position_ball_0_0 position_ball_0
       (.ball_pos_x(position_ball_0_ball_pos_x),
        ...
        .screen_size_x(Net5),
        .screen_size_y(Net6));
  PONG_position_paddles_0_0 position_paddles_0
  ...
  PONG_score_counter_0_0 score_counter_0
       (.clk(Net4),
  ...
  PONG_util_vector_logic_2_0 util_vector_logic_2
       (.Op1(Net3),
        .Op2(score_counter_0_game_reset),
        .Res(util_vector_logic_2_Res));
  PONG_v_tc_0_0 v_tc_0
  ...
  PONG_video_buffer_0_0 video_buffer_0
...
module controllers_imp_10DA66H
   (btn_down_0,
    btn_down_1,
    btn_up_0,
    btn_up_1,
  ...
  PONG_clk_divider_1_0 clk_divider_1
       (.clk_i(Net),
        .clk_o(clk_divider_1_clk_o),
        .reset(Net3));
  PONG_controller_buttons_0_0 controller_buttons_0
  ...
  PONG_controller_buttons_1_0 controller_buttons_1
  ...
  PONG_controller_interconn_0_0 controller_interconn_0
  ...
  PONG_controller_ultrasoni_1_0 controller_ultrasoni_1
       (.clk(Net),
...
module paint_scoreboard_imp_1D47EDC
  ...
  paint_seg_l_imp_XXHWUM paint_seg_l
       (.clk(clk_1),
        .hsync_i(hsync_i_2),
  ...
  paint_seg_r_imp_19Y4ORX paint_seg_r
       (.clk(clk_1),
  ...
  PONG_scoreboard_controller_0_0 scoreboard_controller_0
       (.clk(clk_1),
...
module paint_seg_l_imp_XXHWUM
  ...
  PONG_paint_rectangle_0_0 paint_rectangle_0
       (.clk(Net),
        ...
        .vsync_i(vsync_i_0_1),
        .vsync_o(paint_rectangle_0_vsync_o));
  PONG_paint_rectangle_1_0 paint_rectangle_1
       (.clk(Net),
        ...
        .vsync_i(paint_rectangle_0_vsync_o),
        .vsync_o(paint_rectangle_1_vsync_o));
  PONG_paint_rectangle_2_0 paint_rectangle_2
       (.clk(Net),
        ...
        .vsync_i(paint_rectangle_1_vsync_o),
        .vsync_o(paint_rectangle_2_vsync_o));
  PONG_paint_rectangle_3_0 paint_rectangle_3
       (.clk(Net),
  ...
  PONG_paint_rectangle_4_0 paint_rectangle_4
       (.clk(Net),
  ...
  PONG_paint_rectangle_5_0 paint_rectangle_5
       (.clk(Net),
  ...
  PONG_paint_rectangle_6_0 paint_rectangle_6
       (.clk(Net),
  ...
  PONG_seven_seg_display_co_0_0 seven_seg_display_co_0
       (.clk(clk_1_1),
        .reset(reset_0_1),
...
module paint_seg_r_imp_19Y4ORX
   (clk,
    hsync_i,
    hsync_o,
    pxlClk,
  ...
  assign vsync_i_0_1 = vsync_i;
  assign vsync_o = paint_rectangle_6_vsync_o;
  PONG_paint_rectangle_0_1 paint_rectangle_0
       (.clk(Net),
        .enable(seven_seg_display_co_0_seg_a),
        .hsync_i(hsync_i_0_1),
        .hsync_o(paint_rectangle_0_hsync_o),
        ...
        .vsync_i(vsync_i_0_1),
        .vsync_o(paint_rectangle_0_vsync_o));
  PONG_paint_rectangle_1_1 paint_rectangle_1
       (.clk(Net),
        .enable(seven_seg_display_co_0_seg_b),
        .hsync_i(paint_rectangle_0_hsync_o),
        .hsync_o(paint_rectangle_1_hsync_o),
        ...
        .vsync_i(paint_rectangle_0_vsync_o),
        .vsync_o(paint_rectangle_1_vsync_o));
  PONG_paint_rectangle_2_1 paint_rectangle_2
       (.clk(Net),
        .enable(seven_seg_display_co_0_seg_c),
        .hsync_i(paint_rectangle_1_hsync_o),
        .hsync_o(paint_rectangle_2_hsync_o),
        ...
        .vsync_i(paint_rectangle_1_vsync_o),
        .vsync_o(paint_rectangle_2_vsync_o));
  PONG_paint_rectangle_3_1 paint_rectangle_3
       (.clk(Net),
        .enable(seven_seg_display_co_0_seg_d),
        .hsync_i(paint_rectangle_2_hsync_o),
        .hsync_o(paint_rectangle_3_hsync_o),
        ...
        .vsync_i(paint_rectangle_2_vsync_o),
        .vsync_o(paint_rectangle_3_vsync_o));
  PONG_paint_rectangle_4_1 paint_rectangle_4
       (.clk(Net),
        .enable(seven_seg_display_co_0_seg_e),
        .hsync_i(paint_rectangle_3_hsync_o),
        .hsync_o(paint_rectangle_4_hsync_o),
        ...
        .vsync_i(paint_rectangle_3_vsync_o),
        .vsync_o(paint_rectangle_4_vsync_o));
  PONG_paint_rectangle_5_1 paint_rectangle_5
       (.clk(Net),
        .enable(seven_seg_display_co_0_seg_f),
        .hsync_i(paint_rectangle_4_hsync_o),
        .hsync_o(paint_rectangle_5_hsync_o),
        ...
        .vsync_i(paint_rectangle_4_vsync_o),
        .vsync_o(paint_rectangle_5_vsync_o));
  PONG_paint_rectangle_6_1 paint_rectangle_6
       (.clk(Net),
        .enable(seven_seg_display_co_0_seg_g),
        .hsync_i(paint_rectangle_5_hsync_o),
        .hsync_o(paint_rectangle_6_hsync_o),
        ...
        .vsync_i(paint_rectangle_5_vsync_o),
        .vsync_o(paint_rectangle_6_vsync_o));
  PONG_seven_seg_display_co_0_1 seven_seg_display_co_0
       (.clk(clk_1_1),
        .reset(reset_0_1),
        .seg_a(seven_seg_display_co_0_seg_a),
        .seg_a_pos_x(seven_seg_display_co_0_seg_a_pos_x),
