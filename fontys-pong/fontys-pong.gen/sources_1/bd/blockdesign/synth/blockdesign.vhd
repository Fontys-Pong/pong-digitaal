...
entity blockdesign is
  ...
  attribute CORE_GENERATION_INFO of blockdesign : entity is "blockdesign,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=blockdesign,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=27,numReposBlks=25,numNonXlnxBlks=0,numHierBlks=2,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=15,numPkgbdBlks=0,bdsource=USER,da_board_cnt=1,da_clkrst_cnt=1,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of blockdesign is
  ...
  signal xlconstant_5_dout : STD_LOGIC_VECTOR ( 10 downto 0 );
  signal xlconstant_6_dout : STD_LOGIC_VECTOR ( 10 downto 0 );
  signal NLW_paint_centerline_0_pxl_value_o_UNCONNECTED : STD_LOGIC;
...
begin
  ...
  btn_up_1_1 <= btn_up_r;
  enable_0_1 <= enable;
  hsync_o_0 <= paint_centerline_0_hsync_o;
  sensor_0_1 <= sensor_l;
  sensor_1_1 <= sensor_r;
  ...
  video_enable_o_0 <= paint_centerline_0_video_enable_o;
  vsync_o_0 <= paint_centerline_0_vsync_o;
...
paint_ball: component blockdesign_paint_rectangle_0_0
     port map (
      ...
      pxl_x_i(10 downto 0) => B"00000000000",
      pxl_x_o(10 downto 0) => paint_rectangle_0_pxl_x_o(10 downto 0),
      pxl_y_i(10 downto 0) => B"00000000000",
...
paint_centerline_0: component blockdesign_paint_centerline_0_0
     port map (
      ...
      pxl_value_o => NLW_paint_centerline_0_pxl_value_o_UNCONNECTED,
