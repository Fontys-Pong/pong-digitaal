...
-- Date        : Mon Mar 25 18:21:41 2024
-- Host        : Lenovo-Jochem running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/Jochem/GitHub/Fontys/pong-digitaal/fontys-pong/fontys-pong.gen/sources_1/bd/blockdesign/ip/blockdesign_paint_rectangle_1_0/blockdesign_paint_rectangle_1_0_sim_netlist.vhdl
...
entity blockdesign_paint_rectangle_1_0_paint_rectangle is
  port (
  ...
  attribute ORIG_REF_NAME of blockdesign_paint_rectangle_1_0_paint_rectangle : entity is "paint_rectangle";
end blockdesign_paint_rectangle_1_0_paint_rectangle;

architecture STRUCTURE of blockdesign_paint_rectangle_1_0_paint_rectangle is
  ...
  signal \pxl_value_o3_carry__0_i_1_n_0\ : STD_LOGIC;
  signal \pxl_value_o3_carry__0_i_2_n_0\ : STD_LOGIC;
  signal \pxl_value_o3_carry__0_i_3_n_0\ : STD_LOGIC;
  signal \pxl_value_o3_carry__0_i_4_n_0\ : STD_LOGIC;
  signal \pxl_value_o3_carry__0_n_2\ : STD_LOGIC;
  signal \pxl_value_o3_carry__0_n_3\ : STD_LOGIC;
  signal pxl_value_o3_carry_i_1_n_0 : STD_LOGIC;
  signal pxl_value_o3_carry_i_2_n_0 : STD_LOGIC;
  signal pxl_value_o3_carry_i_3_n_0 : STD_LOGIC;
  signal pxl_value_o3_carry_i_4_n_0 : STD_LOGIC;
  signal pxl_value_o3_carry_i_5_n_0 : STD_LOGIC;
  signal pxl_value_o3_carry_i_6_n_0 : STD_LOGIC;
  signal pxl_value_o3_carry_i_7_n_0 : STD_LOGIC;
  signal pxl_value_o3_carry_i_8_n_0 : STD_LOGIC;
  signal pxl_value_o3_carry_n_0 : STD_LOGIC;
  signal pxl_value_o3_carry_n_1 : STD_LOGIC;
  signal pxl_value_o3_carry_n_2 : STD_LOGIC;
  signal pxl_value_o3_carry_n_3 : STD_LOGIC;
  ...
  signal \pxl_value_o4_carry__0_n_0\ : STD_LOGIC;
  signal \pxl_value_o4_carry__0_n_1\ : STD_LOGIC;
  signal \pxl_value_o4_carry__0_n_2\ : STD_LOGIC;
  signal \pxl_value_o4_carry__0_n_3\ : STD_LOGIC;
  signal \pxl_value_o4_carry__0_n_4\ : STD_LOGIC;
  signal \pxl_value_o4_carry__0_n_5\ : STD_LOGIC;
  signal \pxl_value_o4_carry__0_n_6\ : STD_LOGIC;
  signal \pxl_value_o4_carry__0_n_7\ : STD_LOGIC;
  signal \pxl_value_o4_carry__1_i_1_n_0\ : STD_LOGIC;
  signal \pxl_value_o4_carry__1_i_2_n_0\ : STD_LOGIC;
  signal \pxl_value_o4_carry__1_i_3_n_0\ : STD_LOGIC;
  signal \pxl_value_o4_carry__1_n_2\ : STD_LOGIC;
  signal \pxl_value_o4_carry__1_n_3\ : STD_LOGIC;
  signal \pxl_value_o4_carry__1_n_5\ : STD_LOGIC;
  signal \pxl_value_o4_carry__1_n_6\ : STD_LOGIC;
  signal \pxl_value_o4_carry__1_n_7\ : STD_LOGIC;
  ...
  signal pxl_value_o4_carry_n_4 : STD_LOGIC;
  signal pxl_value_o4_carry_n_5 : STD_LOGIC;
  signal pxl_value_o4_carry_n_6 : STD_LOGIC;
  signal pxl_value_o4_carry_n_7 : STD_LOGIC;
  ...
  signal NLW_pxl_value_o3_carry_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_pxl_value_o3_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_pxl_value_o3_carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_pxl_value_o4_carry__1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_pxl_value_o4_carry__1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute COMPARATOR_THRESHOLD of pxl_value_o3_carry : label is 11;
  attribute COMPARATOR_THRESHOLD of \pxl_value_o3_carry__0\ : label is 11;
  attribute ADDER_THRESHOLD of pxl_value_o4_carry : label is 35;
  attribute ADDER_THRESHOLD of \pxl_value_o4_carry__0\ : label is 35;
  attribute ADDER_THRESHOLD of \pxl_value_o4_carry__1\ : label is 35;
begin
...
pxl_value_o3_carry: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => pxl_value_o3_carry_n_0,
      CO(2) => pxl_value_o3_carry_n_1,
      CO(1) => pxl_value_o3_carry_n_2,
      CO(0) => pxl_value_o3_carry_n_3,
      CYINIT => '1',
      DI(3) => pxl_value_o3_carry_i_1_n_0,
      DI(2) => pxl_value_o3_carry_i_2_n_0,
      DI(1) => pxl_value_o3_carry_i_3_n_0,
      DI(0) => pxl_value_o3_carry_i_4_n_0,
      O(3 downto 0) => NLW_pxl_value_o3_carry_O_UNCONNECTED(3 downto 0),
      S(3) => pxl_value_o3_carry_i_5_n_0,
      S(2) => pxl_value_o3_carry_i_6_n_0,
      S(1) => pxl_value_o3_carry_i_7_n_0,
      S(0) => pxl_value_o3_carry_i_8_n_0
    );
\pxl_value_o3_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => pxl_value_o3_carry_n_0,
      CO(3 downto 2) => \NLW_pxl_value_o3_carry__0_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \pxl_value_o3_carry__0_n_2\,
      CO(0) => \pxl_value_o3_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => \pxl_value_o3_carry__0_i_1_n_0\,
      DI(0) => \pxl_value_o3_carry__0_i_2_n_0\,
      O(3 downto 0) => \NLW_pxl_value_o3_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3 downto 2) => B"00",
      S(1) => \pxl_value_o3_carry__0_i_3_n_0\,
      S(0) => \pxl_value_o3_carry__0_i_4_n_0\
    );
\pxl_value_o3_carry__0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => pxl_x_i(10),
      I1 => rect_pos_x(10),
      O => \pxl_value_o3_carry__0_i_1_n_0\
    );
\pxl_value_o3_carry__0_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2F02"
    )
        port map (
      ...
      I2 => rect_pos_x(9),
      I3 => pxl_x_i(9),
      O => \pxl_value_o3_carry__0_i_2_n_0\
    );
\pxl_value_o3_carry__0_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
      I0 => rect_pos_x(10),
      I1 => pxl_x_i(10),
      O => \pxl_value_o3_carry__0_i_3_n_0\
    );
\pxl_value_o3_carry__0_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      I2 => pxl_x_i(9),
      I3 => rect_pos_x(9),
      O => \pxl_value_o3_carry__0_i_4_n_0\
    );
pxl_value_o3_carry_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2F02"
    )
        port map (
      ...
      I2 => rect_pos_x(7),
      I3 => pxl_x_i(7),
      O => pxl_value_o3_carry_i_1_n_0
    );
pxl_value_o3_carry_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2F02"
    )
        port map (
      ...
      I2 => rect_pos_x(5),
      I3 => pxl_x_i(5),
      O => pxl_value_o3_carry_i_2_n_0
    );
pxl_value_o3_carry_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2F02"
    )
        port map (
      ...
      I2 => rect_pos_x(3),
      I3 => pxl_x_i(3),
      O => pxl_value_o3_carry_i_3_n_0
    );
pxl_value_o3_carry_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2F02"
    )
        port map (
      ...
      I2 => rect_pos_x(1),
      I3 => pxl_x_i(1),
      O => pxl_value_o3_carry_i_4_n_0
    );
pxl_value_o3_carry_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      I2 => pxl_x_i(7),
      I3 => rect_pos_x(7),
      O => pxl_value_o3_carry_i_5_n_0
    );
pxl_value_o3_carry_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      I2 => pxl_x_i(5),
      I3 => rect_pos_x(5),
      O => pxl_value_o3_carry_i_6_n_0
    );
pxl_value_o3_carry_i_7: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      I2 => pxl_x_i(3),
      I3 => rect_pos_x(3),
      O => pxl_value_o3_carry_i_7_n_0
    );
pxl_value_o3_carry_i_8: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
...
pxl_value_o4_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3) => pxl_value_o4_carry_n_4,
      O(2) => pxl_value_o4_carry_n_5,
      O(1) => pxl_value_o4_carry_n_6,
      O(0) => pxl_value_o4_carry_n_7,
      S(3) => pxl_value_o4_carry_i_1_n_0,
      S(2) => pxl_value_o4_carry_i_2_n_0,
      S(1) => pxl_value_o4_carry_i_3_n_0,
      S(0) => pxl_value_o4_carry_i_4_n_0
    );
\pxl_value_o4_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => pxl_value_o4_carry_n_0,
      CO(3) => \pxl_value_o4_carry__0_n_0\,
      CO(2) => \pxl_value_o4_carry__0_n_1\,
      CO(1) => \pxl_value_o4_carry__0_n_2\,
      CO(0) => \pxl_value_o4_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => rect_pos_x(7 downto 4),
      O(3) => \pxl_value_o4_carry__0_n_4\,
      O(2) => \pxl_value_o4_carry__0_n_5\,
      O(1) => \pxl_value_o4_carry__0_n_6\,
      O(0) => \pxl_value_o4_carry__0_n_7\,
      S(3) => \pxl_value_o4_carry__0_i_1_n_0\,
      S(2) => \pxl_value_o4_carry__0_i_2_n_0\,
...
\pxl_value_o4_carry__0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\pxl_value_o4_carry__0_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\pxl_value_o4_carry__1\: unisim.vcomponents.CARRY4
     port map (
      CI => \pxl_value_o4_carry__0_n_0\,
      CO(3 downto 2) => \NLW_pxl_value_o4_carry__1_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \pxl_value_o4_carry__1_n_2\,
      CO(0) => \pxl_value_o4_carry__1_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1 downto 0) => rect_pos_x(9 downto 8),
      O(3) => \NLW_pxl_value_o4_carry__1_O_UNCONNECTED\(3),
      O(2) => \pxl_value_o4_carry__1_n_5\,
      O(1) => \pxl_value_o4_carry__1_n_6\,
      O(0) => \pxl_value_o4_carry__1_n_7\,
      S(3) => '0',
      S(2) => \pxl_value_o4_carry__1_i_1_n_0\,
      S(1) => \pxl_value_o4_carry__1_i_2_n_0\,
      S(0) => \pxl_value_o4_carry__1_i_3_n_0\
    );
\pxl_value_o4_carry__1_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => rect_pos_x(10),
      I1 => rect_size_x(10),
      O => \pxl_value_o4_carry__1_i_1_n_0\
    );
\pxl_value_o4_carry__1_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => rect_pos_x(9),
      I1 => rect_size_x(9),
      O => \pxl_value_o4_carry__1_i_2_n_0\
    );
\pxl_value_o4_carry__1_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => rect_pos_x(8),
      I1 => rect_size_x(8),
      O => \pxl_value_o4_carry__1_i_3_n_0\
    );
pxl_value_o4_carry_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
pxl_value_o4_carry_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
pxl_value_o4_carry_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
pxl_value_o4_carry_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
pxl_value_o_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AABAAAAA"
    )
        port map (
      I0 => pxl_value_i,
      I1 => \_carry__1_n_1\,
      I2 => \pxl_value_o2_carry__0_n_2\,
      I3 => \__21_carry__1_n_1\,
      I4 => \pxl_value_o3_carry__0_n_2\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity blockdesign_paint_rectangle_1_0 is
  port (
    clk : in STD_LOGIC;
    video_enable_i : in STD_LOGIC;
    hsync_i : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of blockdesign_paint_rectangle_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of blockdesign_paint_rectangle_1_0 : entity is "blockdesign_paint_rectangle_1_0,paint_rectangle,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of blockdesign_paint_rectangle_1_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of blockdesign_paint_rectangle_1_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of blockdesign_paint_rectangle_1_0 : entity is "paint_rectangle,Vivado 2023.1";
end blockdesign_paint_rectangle_1_0;

architecture STRUCTURE of blockdesign_paint_rectangle_1_0 is
...
begin
U0: entity work.blockdesign_paint_rectangle_1_0_paint_rectangle
     port map (
      clk => clk,
      hsync_i => hsync_i,
      hsync_o => hsync_o,
