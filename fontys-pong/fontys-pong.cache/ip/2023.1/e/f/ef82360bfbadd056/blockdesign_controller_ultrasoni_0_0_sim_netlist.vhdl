...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller_ultrasonic_hcsr04 is
  ...
  attribute SOFT_HLUTNM of \distance_mm[22]_i_155\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \distance_mm[22]_i_156\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \distance_mm[22]_i_157\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \distance_mm[22]_i_158\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \distance_mm[22]_i_216\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \next_state[1]_i_2\ : label is "soft_lutpair3";
...
\next_state[0]_i_10\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\next_state[0]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\next_state[0]_i_13\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      I0 => trigger_counter_reg(25),
      I1 => trigger_counter_reg(29),
...
\next_state[0]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\next_state[0]_i_7\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\next_state[1]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00440004"
    )
        port map (
...
\next_state[2]_i_10\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\next_state[2]_i_11\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F8000000"
    )
        port map (
...
\next_state[2]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      I0 => wait_echo_start_counter_reg(19),
      I1 => wait_echo_start_counter_reg(28),
      I2 => wait_echo_start_counter_reg(23),
      I3 => wait_echo_start_counter_reg(25),
      O => \next_state[2]_i_12_n_0\
    );
\next_state[2]_i_13\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFE0"
    )
        port map (
      I0 => wait_echo_start_counter_reg(1),
      I1 => wait_echo_start_counter_reg(2),
      I2 => wait_echo_start_counter_reg(3),
      I3 => wait_echo_start_counter_reg(27),
      I4 => wait_echo_start_counter_reg(18),
      I5 => wait_echo_start_counter_reg(6),
...
\next_state[2]_i_14\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => wait_echo_start_counter_reg(14),
      I1 => wait_echo_start_counter_reg(26),
      I2 => wait_echo_start_counter_reg(11),
...
\next_state[2]_i_15\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => wait_echo_start_counter_reg(9),
      I1 => wait_echo_start_counter_reg(16),
      I2 => wait_echo_start_counter_reg(8),
...
\next_state[2]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
        ...
        port map (
      I0 => wait_counter_reg(28),
      I1 => wait_counter_reg(23),
      I2 => wait_counter_reg(29),
      I3 => wait_counter_reg(27),
...
\next_state[2]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
        ...
        port map (
      I0 => \next_state[2]_i_12_n_0\,
      I1 => wait_echo_start_counter_reg(7),
      I2 => wait_echo_start_counter_reg(12),
      I3 => wait_echo_start_counter_reg(4),
      I4 => wait_echo_start_counter_reg(10),
      I5 => \next_state[2]_i_13_n_0\,
      O => \next_state[2]_i_6_n_0\
    );
\next_state[2]_i_7\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => wait_echo_start_counter_reg(15),
      I2 => wait_echo_start_counter_reg(17),
      I3 => wait_echo_start_counter_reg(13),
      I4 => \next_state[2]_i_14_n_0\,
      O => \next_state[2]_i_7_n_0\
    );
\next_state[2]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
      I0 => wait_echo_start_counter_reg(22),
      I1 => wait_echo_start_counter_reg(5),
      I2 => wait_echo_start_counter_reg(24),
      I3 => wait_echo_start_counter_reg(21),
      I4 => \next_state[2]_i_15_n_0\,
      O => \next_state[2]_i_8_n_0\
    );
\next_state[2]_i_9\: unisim.vcomponents.LUT6
    generic map(
...
\wait_echo_start_counter[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
