...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L util_vector_logic_v2_0_2 -L xil_defaultlib -L xlconstant_v1_1_7 -L axi_lite_ipif_v3_0_4 -L v_tc_v6_2_6 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PONG xil_defaultlib.PONG xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim PONG -key {Behavioral:sim_1:Functional:PONG} -tclbatch cmd.tcl -protoinst "protoinst_files/ZYNQ.protoinst" -protoinst "protoinst_files/bd_d804.protoinst" -protoinst "protoinst_files/PONG.protoinst" -protoinst "protoinst_files/blockdesign_inst_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PONG.wdb xsim.dir libdpi.so)
