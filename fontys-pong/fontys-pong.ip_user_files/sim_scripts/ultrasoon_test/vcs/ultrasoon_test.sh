...
#
# Script generated by Vivado on Wed Aug 07 18:31:13 +0200 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : ultrasoon_test.sh
...
#
# Usage        : ultrasoon_test.sh
#                ultrasoon_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ultrasoon_test.sh [-reset_run]
#                ultrasoon_test.sh [-reset_log]
#                ultrasoon_test.sh [-help]
#
...
#                script (type 'ultrasoon_test.sh -help' for more information).
#
...
# script info
echo -e "ultrasoon_test.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ultrasoon_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../fontys-pong.gen/sources_1/bd/ultrasoon_test/ipshared/30ef" +incdir+"../../../../fontys-pong.gen/sources_1/bd/ultrasoon_test/ipshared/30ef" +incdir+"../../../../fontys-pong.gen/sources_1/bd/ultrasoon_test/ipshared/1b7e/hdl/verilog" +incdir+"../../../../fontys-pong.gen/sources_1/bd/ultrasoon_test/ipshared/122e/hdl/verilog" +incdir+"../../../../fontys-pong.gen/sources_1/bd/ultrasoon_test/ipshared/affe/hdl/verilog" +incdir+"../../../../fontys-pong.gen/sources_1/bd/ultrasoon_test/ipshared/20d0/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ultrasoon_test xil_defaultlib.glbl -o ultrasoon_test_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ultrasoon_test_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ultrasoon_test_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ultrasoon_test_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ultrasoon_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ultrasoon_test.sh [-help]\n\
Usage: ultrasoon_test.sh [-step]\n\
Usage: ultrasoon_test.sh [-lib_map_path]\n\
Usage: ultrasoon_test.sh [-reset_run]\n\
Usage: ultrasoon_test.sh [-reset_log]\n\
Usage: ultrasoon_test.sh [-keep_index]\n\
Usage: ultrasoon_test.sh [-noclean_files]\n\n\
