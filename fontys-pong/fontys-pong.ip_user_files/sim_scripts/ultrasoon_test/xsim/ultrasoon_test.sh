...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ultrasoon_test xil_defaultlib.ultrasoon_test xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ultrasoon_test -key {Behavioral:sim_1:Functional:ultrasoon_test} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d804.protoinst" -protoinst "protoinst_files/ultrasoon_test.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ultrasoon_test.wdb xsim.dir libdpi.so)
