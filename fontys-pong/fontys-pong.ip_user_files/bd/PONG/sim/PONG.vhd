...
entity Constants_imp_YX2WQJ is
  port (
...
architecture STRUCTURE of Constants_imp_YX2WQJ is
  ...
  end component PONG_paddle_size_x_0;
  component PONG_paddle_size_y_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 10 downto 0 )
  );
  ...
  end component PONG_score_seg_size_x_0;
  component PONG_score_seg_size_y_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 10 downto 0 )
  );
  end component PONG_score_seg_size_y_0;
  component PONG_scoreboard_center_offset_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 10 downto 0 )
  );
  end component PONG_scoreboard_center_offset_0;
  component PONG_scoreboard_top_offset_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 10 downto 0 )
  );
...
ball_size_RnM: component PONG_ball_size_0
     port map (
      dout(10 downto 0) => Net9(10 downto 0)
    );
max_score_RnM: component PONG_max_score_0
     port map (
      dout(3 downto 0) => xlconstant_6_dout(3 downto 0)
    );
paddle_offset_x_RnM: component PONG_paddle_offset_x_0
     port map (
      dout(10 downto 0) => xlconstant_5_dout(10 downto 0)
    );
paddle_size_x_RnM: component PONG_paddle_size_x_0
     port map (
      dout(10 downto 0) => Net7(10 downto 0)
    );
paddle_size_y_RnM: component PONG_paddle_size_y_0
     port map (
      dout(10 downto 0) => Net8(10 downto 0)
    );
score_seg_size_x_RnM: component PONG_score_seg_size_x_0
     port map (
      dout(10 downto 0) => score_seg_size_x_dout(10 downto 0)
    );
score_seg_size_y_RnM: component PONG_score_seg_size_y_0
     port map (
      dout(10 downto 0) => score_seg_size_y_dout(10 downto 0)
    );
scoreboard_center_offset_RnM: component PONG_scoreboard_center_offset_0
     port map (
      dout(10 downto 0) => scoreboard_center_offset_dout(10 downto 0)
    );
scoreboard_top_offset_RnM: component PONG_scoreboard_top_offset_0
     port map (
      dout(10 downto 0) => scoreboard_top_offset_dout(10 downto 0)
    );
screen_size_x_RnM: component PONG_screen_size_x_0
     port map (
      dout(10 downto 0) => Net5(10 downto 0)
    );
screen_size_y_RnM: component PONG_screen_size_y_0
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity controllers_imp_10DA66H is
  port (
...
architecture STRUCTURE of controllers_imp_10DA66H is
  ...
  end component PONG_controller_ultrasoni_0_0;
  component PONG_controller_ultrasoni_1_0 is
  port (
    clk : in STD_LOGIC;
    reset_i : in STD_LOGIC;
    enable : in STD_LOGIC;
...
clk_divider_1: component PONG_clk_divider_1_0
     port map (
      clk_i => Net,
      clk_o => clk_divider_1_clk_o,
      reset => Net3
    );
controller_buttons_0: component PONG_controller_buttons_0_0
     port map (
...
controller_buttons_1: component PONG_controller_buttons_1_0
     port map (
...
controller_interconn_0: component PONG_controller_interconn_0_0
     port map (
...
controller_ultrasoni_0: component PONG_controller_ultrasoni_0_0
     port map (
      clk => Net,
...
controller_ultrasoni_1: component PONG_controller_ultrasoni_1_0
     port map (
      clk => Net,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity paint_seg_l_imp_XXHWUM is
  port (
    clk : in STD_LOGIC;
...
architecture STRUCTURE of paint_seg_l_imp_XXHWUM is
  ...
  end component PONG_paint_rectangle_0_0;
  component PONG_paint_rectangle_1_0 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    video_enable_i : in STD_LOGIC;
  ...
  end component PONG_paint_rectangle_1_0;
  component PONG_paint_rectangle_2_0 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    video_enable_i : in STD_LOGIC;
  ...
  end component PONG_paint_rectangle_2_0;
  component PONG_paint_rectangle_3_0 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    video_enable_i : in STD_LOGIC;
  ...
  end component PONG_paint_rectangle_3_0;
  component PONG_paint_rectangle_4_0 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    video_enable_i : in STD_LOGIC;
  ...
  end component PONG_paint_rectangle_4_0;
  component PONG_paint_rectangle_5_0 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    video_enable_i : in STD_LOGIC;
  ...
  end component PONG_paint_rectangle_5_0;
  component PONG_paint_rectangle_6_0 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    video_enable_i : in STD_LOGIC;
...
paint_rectangle_0: component PONG_paint_rectangle_0_0
     port map (
      clk => Net,
...
paint_rectangle_1: component PONG_paint_rectangle_1_0
     port map (
      clk => Net,
...
paint_rectangle_2: component PONG_paint_rectangle_2_0
     port map (
      clk => Net,
...
paint_rectangle_3: component PONG_paint_rectangle_3_0
     port map (
      clk => Net,
...
paint_rectangle_4: component PONG_paint_rectangle_4_0
     port map (
      clk => Net,
...
paint_rectangle_5: component PONG_paint_rectangle_5_0
     port map (
      clk => Net,
...
paint_rectangle_6: component PONG_paint_rectangle_6_0
     port map (
      clk => Net,
...
seven_seg_display_co_0: component PONG_seven_seg_display_co_0_0
     port map (
      clk => clk_1_1,
      reset => reset_0_1,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity paint_seg_r_imp_19Y4ORX is
  port (
    clk : in STD_LOGIC;
    hsync_i : in STD_LOGIC;
    hsync_o : out STD_LOGIC;
...
architecture STRUCTURE of paint_seg_r_imp_19Y4ORX is
  ...
  end component PONG_paint_rectangle_0_1;
  component PONG_paint_rectangle_1_1 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    video_enable_i : in STD_LOGIC;
  ...
  end component PONG_paint_rectangle_1_1;
  component PONG_paint_rectangle_2_1 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    video_enable_i : in STD_LOGIC;
  ...
  end component PONG_paint_rectangle_2_1;
  component PONG_paint_rectangle_3_1 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    video_enable_i : in STD_LOGIC;
  ...
  end component PONG_paint_rectangle_3_1;
  component PONG_paint_rectangle_4_1 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    video_enable_i : in STD_LOGIC;
  ...
  end component PONG_paint_rectangle_4_1;
  component PONG_paint_rectangle_5_1 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    video_enable_i : in STD_LOGIC;
  ...
  end component PONG_paint_rectangle_5_1;
  component PONG_paint_rectangle_6_1 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    video_enable_i : in STD_LOGIC;
...
begin
  ...
  vsync_i_0_1 <= vsync_i;
  vsync_o <= paint_rectangle_6_vsync_o;
paint_rectangle_0: component PONG_paint_rectangle_0_1
     port map (
      clk => Net,
      enable => seven_seg_display_co_0_seg_a,
      hsync_i => hsync_i_0_1,
...
paint_rectangle_1: component PONG_paint_rectangle_1_1
     port map (
      clk => Net,
      enable => seven_seg_display_co_0_seg_b,
      hsync_i => paint_rectangle_0_hsync_o,
...
paint_rectangle_2: component PONG_paint_rectangle_2_1
     port map (
      clk => Net,
      enable => seven_seg_display_co_0_seg_c,
      hsync_i => paint_rectangle_1_hsync_o,
...
paint_rectangle_3: component PONG_paint_rectangle_3_1
     port map (
      clk => Net,
      enable => seven_seg_display_co_0_seg_d,
      hsync_i => paint_rectangle_2_hsync_o,
...
paint_rectangle_4: component PONG_paint_rectangle_4_1
     port map (
      clk => Net,
      enable => seven_seg_display_co_0_seg_e,
      hsync_i => paint_rectangle_3_hsync_o,
...
paint_rectangle_5: component PONG_paint_rectangle_5_1
     port map (
      clk => Net,
      enable => seven_seg_display_co_0_seg_f,
      hsync_i => paint_rectangle_4_hsync_o,
...
paint_rectangle_6: component PONG_paint_rectangle_6_1
     port map (
      clk => Net,
      enable => seven_seg_display_co_0_seg_g,
      hsync_i => paint_rectangle_5_hsync_o,
...
seven_seg_display_co_0: component PONG_seven_seg_display_co_0_1
     port map (
      clk => clk_1_1,
      reset => reset_0_1,
      seg_a => seven_seg_display_co_0_seg_a,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity paint_scoreboard_imp_1D47EDC is
  port (
    clk : in STD_LOGIC;
    hsync_i : in STD_LOGIC;
    hsync_o : out STD_LOGIC;
...
end paint_scoreboard_imp_1D47EDC;

architecture STRUCTURE of paint_scoreboard_imp_1D47EDC is
  component PONG_scoreboard_controller_0_0 is
  port (
    clk : in STD_LOGIC;
    screen_size_x : in STD_LOGIC_VECTOR ( 10 downto 0 );
  ...
  end component PONG_scoreboard_controller_0_0;
...
paint_seg_l: entity work.paint_seg_l_imp_XXHWUM
     port map (
      clk => clk_1,
      hsync_i => hsync_i_2,
...
paint_seg_r: entity work.paint_seg_r_imp_19Y4ORX
     port map (
      clk => clk_1,
...
scoreboard_controller_0: component PONG_scoreboard_controller_0_0
     port map (
      clk => clk_1,
...
entity PONG is
  ...
  attribute CORE_GENERATION_INFO of PONG : entity is "PONG,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=PONG,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=58,numReposBlks=53,numNonXlnxBlks=1,numHierBlks=5,maxHierDepth=2,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=35,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of PONG : entity is "PONG.hwdef";
end PONG;
...
architecture STRUCTURE of PONG is
  ...
  end component PONG_paint_paddle_l_0;
  component PONG_paint_paddle_r_0 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    video_enable_i : in STD_LOGIC;
  ...
  attribute X_INTERFACE_PARAMETER of clk_100MHz : signal is "XIL_INTERFACENAME CLK.CLK_100MHZ, ASSOCIATED_RESET reset, CLK_DOMAIN PONG_clk_100MHz, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
...
Constants: entity work.Constants_imp_YX2WQJ
     port map (
      ball_size(10 downto 0) => Net9(10 downto 0),
      max_score(3 downto 0) => xlconstant_6_dout(3 downto 0),
      paddle_offset_x(10 downto 0) => xlconstant_5_dout(10 downto 0),
...
clk_divider_0: component PONG_clk_divider_0_0
     port map (
      clk_i => Net,
      clk_o => Net4,
      reset => Net3
    );
clk_wiz_0: component PONG_clk_wiz_0_0
     port map (
      clk_hdmi => clk_wiz_0_clk_hdmi,
      clk_in1 => Net,
      reset => Net3
    );
collision_detection_0: component PONG_collision_detection_0_0
     port map (
...
color_generator_0: component PONG_color_generator_0_0
     port map (
      data_o(23 downto 0) => color_generator_0_data_o(23 downto 0),
      enable_i => paint_scoreboard_pxl_value_o
    );
controllers: entity work.controllers_imp_10DA66H
     port map (
...
one: component PONG_one_0
     port map (
      dout(0) => one_dout(0)
    );
paint_ball: component PONG_paint_ball_0
     port map (
...
paint_centerline_0: component PONG_paint_centerline_0_0
     port map (
      clk => clk_wiz_0_clk_hdmi,
      hsync_i => paint_rectangle_2_hsync_o,
...
paint_paddle_l: component PONG_paint_paddle_l_0
     port map (
      clk => clk_wiz_0_clk_hdmi,
      enable => enable_0_1,
      hsync_i => paint_rectangle_0_hsync_o,
...
paint_paddle_r: component PONG_paint_paddle_r_0
     port map (
      clk => clk_wiz_0_clk_hdmi,
      enable => enable_0_1,
      hsync_i => paint_rectangle_1_hsync_o,
...
paint_scoreboard: entity work.paint_scoreboard_imp_1D47EDC
     port map (
      clk => Net,
...
pixel_counter_0: component PONG_pixel_counter_0_0
     port map (
...
position_ball_0: component PONG_position_ball_0_0
     port map (
      ball_pos_x(10 downto 0) => position_ball_0_ball_pos_x(10 downto 0),
...
position_paddles_0: component PONG_position_paddles_0_0
     port map (
...
rgb2dvi_0: component PONG_rgb2dvi_0_0
     port map (
...
score_counter_0: component PONG_score_counter_0_0
     port map (
      clk => Net4,
...
video_buffer_0: component PONG_video_buffer_0_0
     port map (
