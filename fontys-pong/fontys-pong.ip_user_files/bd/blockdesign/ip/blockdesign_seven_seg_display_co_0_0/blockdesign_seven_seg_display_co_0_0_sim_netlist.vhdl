...
--               c:/Users/Jochem/GitHub/Fontys/pong-digitaal/fontys-pong/fontys-pong.gen/sources_1/bd/blockdesign/ip/blockdesign_seven_seg_display_co_0_0/blockdesign_seven_seg_display_co_0_0_sim_netlist.vhdl
...
entity blockdesign_seven_seg_display_co_0_0_seven_seg_display_controller is
  port (
  ...
  attribute ORIG_REF_NAME of blockdesign_seven_seg_display_co_0_0_seven_seg_display_controller : entity is "seven_seg_display_controller";
end blockdesign_seven_seg_display_co_0_0_seven_seg_display_controller;

architecture STRUCTURE of blockdesign_seven_seg_display_co_0_0_seven_seg_display_controller is
  ...
  signal \^seg_e_pos_y\ : STD_LOGIC_VECTOR ( 10 downto 0 );
  signal \seg_e_pos_y[0]_INST_0_i_1_n_0\ : STD_LOGIC;
  signal \seg_e_pos_y[0]_INST_0_i_2_n_0\ : STD_LOGIC;
  signal \seg_e_pos_y[0]_INST_0_i_3_n_0\ : STD_LOGIC;
  signal \seg_e_pos_y[0]_INST_0_i_4_n_0\ : STD_LOGIC;
  signal \seg_e_pos_y[0]_INST_0_n_0\ : STD_LOGIC;
  signal \seg_e_pos_y[0]_INST_0_n_1\ : STD_LOGIC;
  signal \seg_e_pos_y[0]_INST_0_n_2\ : STD_LOGIC;
  signal \seg_e_pos_y[0]_INST_0_n_3\ : STD_LOGIC;
  signal \seg_e_pos_y[4]_INST_0_i_1_n_0\ : STD_LOGIC;
  signal \seg_e_pos_y[4]_INST_0_i_2_n_0\ : STD_LOGIC;
  signal \seg_e_pos_y[4]_INST_0_i_3_n_0\ : STD_LOGIC;
  signal \seg_e_pos_y[4]_INST_0_i_4_n_0\ : STD_LOGIC;
  signal \seg_e_pos_y[4]_INST_0_n_0\ : STD_LOGIC;
  signal \seg_e_pos_y[4]_INST_0_n_1\ : STD_LOGIC;
  signal \seg_e_pos_y[4]_INST_0_n_2\ : STD_LOGIC;
  signal \seg_e_pos_y[4]_INST_0_n_3\ : STD_LOGIC;
  signal \seg_e_pos_y[8]_INST_0_i_1_n_0\ : STD_LOGIC;
  signal \seg_e_pos_y[8]_INST_0_i_2_n_0\ : STD_LOGIC;
  signal \seg_e_pos_y[8]_INST_0_n_2\ : STD_LOGIC;
  signal \seg_e_pos_y[8]_INST_0_n_3\ : STD_LOGIC;
  signal \seg_g_pos_y_carry__0_i_1_n_0\ : STD_LOGIC;
  signal \seg_g_pos_y_carry__0_i_2_n_0\ : STD_LOGIC;
  signal \seg_g_pos_y_carry__0_i_3_n_0\ : STD_LOGIC;
  signal \seg_g_pos_y_carry__0_i_4_n_0\ : STD_LOGIC;
  signal \seg_g_pos_y_carry__0_n_0\ : STD_LOGIC;
  signal \seg_g_pos_y_carry__0_n_1\ : STD_LOGIC;
  signal \seg_g_pos_y_carry__0_n_2\ : STD_LOGIC;
  signal \seg_g_pos_y_carry__0_n_3\ : STD_LOGIC;
  signal \seg_g_pos_y_carry__1_i_1_n_0\ : STD_LOGIC;
  signal \seg_g_pos_y_carry__1_i_2_n_0\ : STD_LOGIC;
  signal \seg_g_pos_y_carry__1_i_3_n_0\ : STD_LOGIC;
  signal \seg_g_pos_y_carry__1_n_2\ : STD_LOGIC;
  signal \seg_g_pos_y_carry__1_n_3\ : STD_LOGIC;
  signal seg_g_pos_y_carry_i_1_n_0 : STD_LOGIC;
  signal seg_g_pos_y_carry_i_2_n_0 : STD_LOGIC;
  signal seg_g_pos_y_carry_i_3_n_0 : STD_LOGIC;
  signal seg_g_pos_y_carry_i_4_n_0 : STD_LOGIC;
  signal seg_g_pos_y_carry_n_0 : STD_LOGIC;
  signal seg_g_pos_y_carry_n_1 : STD_LOGIC;
  signal seg_g_pos_y_carry_n_2 : STD_LOGIC;
  signal seg_g_pos_y_carry_n_3 : STD_LOGIC;
  ...
  signal \NLW_seg_e_pos_y[8]_INST_0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_seg_e_pos_y[8]_INST_0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  signal \NLW_seg_g_pos_y_carry__1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_seg_g_pos_y_carry__1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute ADDER_THRESHOLD of \seg_e_pos_y[0]_INST_0\ : label is 35;
  attribute ADDER_THRESHOLD of \seg_e_pos_y[4]_INST_0\ : label is 35;
  attribute ADDER_THRESHOLD of \seg_e_pos_y[8]_INST_0\ : label is 35;
  attribute SOFT_HLUTNM of \seg_f__0\ : label is "soft_lutpair4";
  attribute ADDER_THRESHOLD of seg_g_pos_y_carry : label is 35;
  attribute ADDER_THRESHOLD of \seg_g_pos_y_carry__0\ : label is 35;
  attribute ADDER_THRESHOLD of \seg_g_pos_y_carry__1\ : label is 35;
...
begin
  seg_e_pos_y(10 downto 0) <= \^seg_e_pos_y\(10 downto 0);
...
\seg_e_pos_y[0]_INST_0\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \seg_e_pos_y[0]_INST_0_n_0\,
      CO(2) => \seg_e_pos_y[0]_INST_0_n_1\,
      CO(1) => \seg_e_pos_y[0]_INST_0_n_2\,
      CO(0) => \seg_e_pos_y[0]_INST_0_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => seg_pos_y(3 downto 0),
      O(3 downto 0) => \^seg_e_pos_y\(3 downto 0),
      S(3) => \seg_e_pos_y[0]_INST_0_i_1_n_0\,
      S(2) => \seg_e_pos_y[0]_INST_0_i_2_n_0\,
      S(1) => \seg_e_pos_y[0]_INST_0_i_3_n_0\,
      S(0) => \seg_e_pos_y[0]_INST_0_i_4_n_0\
    );
\seg_e_pos_y[0]_INST_0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\seg_e_pos_y[0]_INST_0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\seg_e_pos_y[0]_INST_0_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\seg_e_pos_y[0]_INST_0_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\seg_e_pos_y[4]_INST_0\: unisim.vcomponents.CARRY4
     port map (
      CI => \seg_e_pos_y[0]_INST_0_n_0\,
      CO(3) => \seg_e_pos_y[4]_INST_0_n_0\,
      CO(2) => \seg_e_pos_y[4]_INST_0_n_1\,
      CO(1) => \seg_e_pos_y[4]_INST_0_n_2\,
      CO(0) => \seg_e_pos_y[4]_INST_0_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => seg_pos_y(7 downto 4),
      O(3 downto 0) => \^seg_e_pos_y\(7 downto 4),
      S(3) => \seg_e_pos_y[4]_INST_0_i_1_n_0\,
      S(2) => \seg_e_pos_y[4]_INST_0_i_2_n_0\,
      S(1) => \seg_e_pos_y[4]_INST_0_i_3_n_0\,
      S(0) => \seg_e_pos_y[4]_INST_0_i_4_n_0\
    );
\seg_e_pos_y[4]_INST_0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\seg_e_pos_y[4]_INST_0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\seg_e_pos_y[4]_INST_0_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\seg_e_pos_y[4]_INST_0_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\seg_e_pos_y[8]_INST_0\: unisim.vcomponents.CARRY4
     port map (
      CI => \seg_e_pos_y[4]_INST_0_n_0\,
      CO(3 downto 2) => \NLW_seg_e_pos_y[8]_INST_0_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \seg_e_pos_y[8]_INST_0_n_2\,
      CO(0) => \seg_e_pos_y[8]_INST_0_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1 downto 0) => seg_pos_y(9 downto 8),
      O(3) => \NLW_seg_e_pos_y[8]_INST_0_O_UNCONNECTED\(3),
      O(2 downto 0) => \^seg_e_pos_y\(10 downto 8),
      S(3) => '0',
      S(2) => seg_pos_y(10),
      S(1) => \seg_e_pos_y[8]_INST_0_i_1_n_0\,
      S(0) => \seg_e_pos_y[8]_INST_0_i_2_n_0\
    );
\seg_e_pos_y[8]_INST_0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\seg_e_pos_y[8]_INST_0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
seg_g_pos_y_carry: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => seg_g_pos_y_carry_n_0,
      CO(2) => seg_g_pos_y_carry_n_1,
      CO(1) => seg_g_pos_y_carry_n_2,
      CO(0) => seg_g_pos_y_carry_n_3,
      CYINIT => '1',
      DI(3 downto 0) => \^seg_e_pos_y\(3 downto 0),
      O(3 downto 0) => seg_g_pos_y(3 downto 0),
      S(3) => seg_g_pos_y_carry_i_1_n_0,
      S(2) => seg_g_pos_y_carry_i_2_n_0,
      S(1) => seg_g_pos_y_carry_i_3_n_0,
      S(0) => seg_g_pos_y_carry_i_4_n_0
    );
\seg_g_pos_y_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => seg_g_pos_y_carry_n_0,
      CO(3) => \seg_g_pos_y_carry__0_n_0\,
      CO(2) => \seg_g_pos_y_carry__0_n_1\,
      CO(1) => \seg_g_pos_y_carry__0_n_2\,
      CO(0) => \seg_g_pos_y_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => \^seg_e_pos_y\(7 downto 4),
      O(3 downto 0) => seg_g_pos_y(7 downto 4),
      S(3) => \seg_g_pos_y_carry__0_i_1_n_0\,
      S(2) => \seg_g_pos_y_carry__0_i_2_n_0\,
      S(1) => \seg_g_pos_y_carry__0_i_3_n_0\,
      S(0) => \seg_g_pos_y_carry__0_i_4_n_0\
    );
\seg_g_pos_y_carry__0_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\seg_g_pos_y_carry__0_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9995"
    )
        port map (
...
\seg_g_pos_y_carry__0_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"955AA595"
    )
        port map (
...
\seg_g_pos_y_carry__0_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"59A55AA5A59A59A5"
    )
        port map (
      I0 => \^seg_e_pos_y\(4),
      I1 => seg_size_y(5),
...
\seg_g_pos_y_carry__1\: unisim.vcomponents.CARRY4
     port map (
      CI => \seg_g_pos_y_carry__0_n_0\,
      CO(3 downto 2) => \NLW_seg_g_pos_y_carry__1_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \seg_g_pos_y_carry__1_n_2\,
      CO(0) => \seg_g_pos_y_carry__1_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1 downto 0) => \^seg_e_pos_y\(9 downto 8),
      O(3) => \NLW_seg_g_pos_y_carry__1_O_UNCONNECTED\(3),
      O(2 downto 0) => seg_g_pos_y(10 downto 8),
      S(3) => '0',
      S(2) => \seg_g_pos_y_carry__1_i_1_n_0\,
      S(1) => \seg_g_pos_y_carry__1_i_2_n_0\,
      S(0) => \seg_g_pos_y_carry__1_i_3_n_0\
    );
\seg_g_pos_y_carry__1_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\seg_g_pos_y_carry__1_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\seg_g_pos_y_carry__1_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
seg_g_pos_y_carry_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
seg_g_pos_y_carry_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
seg_g_pos_y_carry_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
seg_g_pos_y_carry_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity blockdesign_seven_seg_display_co_0_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    value : in STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute NotValidForBitStream of blockdesign_seven_seg_display_co_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of blockdesign_seven_seg_display_co_0_0 : entity is "blockdesign_seven_seg_display_co_0_0,seven_seg_display_controller,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of blockdesign_seven_seg_display_co_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of blockdesign_seven_seg_display_co_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of blockdesign_seven_seg_display_co_0_0 : entity is "seven_seg_display_controller,Vivado 2023.1";
end blockdesign_seven_seg_display_co_0_0;

architecture STRUCTURE of blockdesign_seven_seg_display_co_0_0 is
...
begin
  ...
  seg_c_pos_y(10 downto 0) <= \^seg_e_pos_y\(10 downto 0);
...
U0: entity work.blockdesign_seven_seg_display_co_0_0_seven_seg_display_controller
     port map (
      clk => clk,
      reset => reset,
      seg_a => seg_a,
