...
HD_PWD='D:/_code/Git/Fontys/CSA/CSA2-pong/pong-digitaal/fontys-pong_Artix7/fontys-pong_Artix7.runs/blockdesign_paint_rectangle_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blockdesign_paint_rectangle_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blockdesign_paint_rectangle_2_0.tcl
