...
HD_PWD='D:/_code/Git/Fontys/CSA/CSA2-pong/pong-digitaal/fontys-pong_Artix7/fontys-pong_Artix7.runs/blockdesign_rgb2dvi_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blockdesign_rgb2dvi_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blockdesign_rgb2dvi_0_1.tcl
