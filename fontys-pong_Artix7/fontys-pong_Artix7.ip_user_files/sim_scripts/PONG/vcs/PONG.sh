...
design_libs=(xpm xlconstant_v1_1_7 xil_defaultlib util_vector_logic_v2_0_2 axi_lite_ipif_v3_0_4 v_tc_v6_2_6)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" +incdir+"../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" \
  ...
  vlogan -work xlconstant_v1_1_7 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" +incdir+"../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" +incdir+"../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" \
  ...
  vlogan -work util_vector_logic_v2_0_2 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" +incdir+"../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.PONG xil_defaultlib.glbl -o PONG_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./PONG_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key PONG_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc PONG_simv.daidir vcs_lib c.obj)
