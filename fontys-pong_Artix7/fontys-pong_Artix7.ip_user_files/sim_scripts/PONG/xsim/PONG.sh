...
simulate()
{
  xsim PONG -key {Behavioral:sim_1:Functional:PONG} -tclbatch cmd.tcl -protoinst "protoinst_files/PONG.protoinst" -protoinst "protoinst_files/CMOD_A7_35T.protoinst" -log simulate.log
}
