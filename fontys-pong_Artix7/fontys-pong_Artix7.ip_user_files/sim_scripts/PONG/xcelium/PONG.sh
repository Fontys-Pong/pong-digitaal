...
#
# Script generated by Vivado on Fri Feb 21 15:52:32 +0100 2025
...
#
# Usage        : PONG.sh
#                PONG.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                PONG.sh [-reset_run]
#                PONG.sh [-reset_log]
#                PONG.sh [-help]
#
...
#                script (type 'PONG.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xlconstant_v1_1_7 -libname xil_defaultlib -libname util_vector_logic_v2_0_2 -libname axi_lite_ipif_v3_0_4 -libname v_tc_v6_2_6 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xlconstant_v1_1_7 xil_defaultlib util_vector_logic_v2_0_2 axi_lite_ipif_v3_0_4 v_tc_v6_2_6)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "PONG.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./PONG.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" +incdir+"../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" \
  ...
  xmvlog -work xlconstant_v1_1_7 $xmvlog_opts +incdir+"$ref_dir/../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" +incdir+"../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" +incdir+"../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" \
  ...
  xmvlog -work util_vector_logic_v2_0_2 $xmvlog_opts +incdir+"$ref_dir/../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" +incdir+"../../../../../fontys-pong/fontys-pong.gen/sources_1/bd/PONG/ipshared/30ef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.PONG xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.PONG -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log PONG_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./PONG.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: PONG.sh [-help]\n\
Usage: PONG.sh [-step]\n\
Usage: PONG.sh [-lib_map_path]\n\
Usage: PONG.sh [-reset_run]\n\
Usage: PONG.sh [-reset_log]\n\
Usage: PONG.sh [-keep_index]\n\
Usage: PONG.sh [-noclean_files]\n\n\
