...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xlconstant_v1_1_7 -L xil_defaultlib -L util_vector_logic_v2_0_2 -L axi_lite_ipif_v3_0_4 -L v_tc_v6_2_6 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot CMOD_A7_35T xil_defaultlib.CMOD_A7_35T xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim CMOD_A7_35T -key {Behavioral:sim_1:Functional:CMOD_A7_35T} -tclbatch cmd.tcl -protoinst "protoinst_files/PONG.protoinst" -protoinst "protoinst_files/CMOD_A7_35T.protoinst" -protoinst "protoinst_files/blockdesign_inst_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb CMOD_A7_35T.wdb xsim.dir libdpi.so)
